...
public class Parking {
    ...
    //Guarda un coche en la posici�n del vector que indique el usuario
    public static void aparcarCoche(Coche[] vCoches){
        ...
        do {         
            ...
            try {
                ...
                if(vCoches[pos] != null) {
                    System.out.println("La plaza est� ocupada. Por favor, introduzca una posici�n v�lida.");
                } else {
                    vCoches[pos] = cAux;
                ...
                System.out.println("Por favor, introduzca una posici�n v�lida");     
                entrada.next();
    ...
    //Muestra la posici�n de las plazas libres que hay en el vector
    ...
    public static void main(String[] args) {
        ...
        do{
            ...
            System.out.println("4. Buscar coche por matr�cula");
            ...
            switch(opcion) {
                ...
                case 4: System.out.println("Buscando coche por matr�cula...");
                        pos = buscarPorMatricula(vCoches);
                        if(pos != -1) {
                            System.out.println("Coche encontrado en la plaza: " + pos);
                        } else {
                            System.out.println("El coche buscado no est� en el garaje");
                        }
                        break;
